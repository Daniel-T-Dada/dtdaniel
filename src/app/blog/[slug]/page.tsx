...
export async function generateMetadata({ params }: PageProps): Promise<Metadata | null> {
    ...
    const jsonLd = {
        article: generateBlogPostSchema(post as any),
    ...
    return {
        ...
        other: {
            ...
            // Handle jsonLd properly by stringifying if needed or passing as script
        },
    };
}
...
export default async function BlogPost({ params }: PageProps) {
    ...
    // We can't await inside the JSX conditionally here easily if we want to pass the slug,
    // but the component itself is async and fetches data.
    // However, the Suspense boundary is wrapping the component call.
    // Let's pass the slug to the component.
