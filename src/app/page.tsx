...
import { getAboutInfo, getProjects, Project } from "@/lib/firebaseHelpers";
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            >
                                {/* Dynamically render about content if available, else static fallback */}
                                {aboutData ? (
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="p-6">
                                            ...
                                            <p className="text-gray-600 dark:text-gray-300 mb-4 h-24 overflow-hidden text-ellipsis">
                                                {project.description}
                                            </p>
