...
export function generateBlogPostSchema(post: BlogPost) {
    return {
        ...
        datePublished: typeof post.createdAt === 'string' ? post.createdAt : post.createdAt?.toString(),
        dateModified: typeof post.updatedAt === 'string' ? post.updatedAt : post.updatedAt?.toString(),
        author: generatePersonSchema(),
        publisher: {
            '@type': 'Person',
            name: 'Daniel Dada',
